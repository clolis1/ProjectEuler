...
public class P11 implements Problem{
    ...
    public void execute() {
        ...
        System.out.println("What is the greatest product of four adjacent numbers in the same direction (up, down, left, right, or diagonally) in the 20×20 grid?");
        ...
        // 1 double for-loop will iterate through each index and test the viability of the northeasterly, easterly, southeasterly, and southerly directions
        
        for (int i = 0; i < grid.length; i++) {
            for (int j = 0; j < grid[i].length; j++) {
                if (i >= 3 && j <= 16) { // Test northeast
